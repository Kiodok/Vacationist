window.VACATIONIST_I18N = {
  ...
  'scan.feat.vote.name': 'Aktivitäten abstimmen',
  'scan.feat.vote.desc': 'Ideen vorschlagen und gemeinsam entscheiden.',
  'scan.feat.expenses.name': 'Ausgaben aufteilen',
  'scan.feat.expenses.desc': 'Wer hat was bezahlt? Am Ende fair abrechnen.',
  'scan.feat.lists.name': 'Geteilte Listen',
  'scan.feat.lists.desc': 'Pack- und Einkaufslisten in Echtzeit synchronisiert.',
  'scan.feat.budget.name': 'Reisebudget',
  'scan.feat.budget.desc': 'Budget festlegen, Ausgaben verfolgen, sehen wer wem was schuldet.',
