window.VACATIONIST_I18N = {
  ...
  'scan.feat.vote.desc': 'Suggest ideas and let the group decide together.',
  'scan.feat.expenses.name': 'Split expenses',
  'scan.feat.expenses.desc': 'Track who paid what. Settle up fairly at the end.',
  'scan.feat.lists.name': 'Shared lists',
  'scan.feat.lists.desc': 'Packing and shopping lists, synced in real time.',
  'scan.feat.budget.name': 'Trip budget',
  'scan.feat.budget.desc': 'Set a budget, track spending, see who owes whom.',
