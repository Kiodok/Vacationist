---
title: Belege & Ausgabenberichte für Gruppenreisen — der Guide
description: Wie ihr auf einer Gruppenreise jeden Beleg behaltet, Kosten fair teilt und pro Person einen Bericht erzeugt, den ihr wirklich einreichen könnt.
path: /de/blog/group-trip-receipts-and-expense-reports/
lang: de
type: article
schema: BlogPosting
date: 2026-09-03
...
- **Klar gemeinsam** — Unterkunft, der Mietwagen, Gruppendinner, an denen alle teilgenommen haben, gemeinsame Einkäufe, für die ganze Gruppe gekaufte Tickets.
- **Klar privat** — deine Souvenirs, die Runde, die du dir selbst gekauft hast, das Museum, das drei Leute ausgelassen haben, dein Upgrade auf ein größeres Zimmer.
- **Verhandelbar** — das Taxi, das vier von neun Leuten genommen haben, die Flasche Wein, die der halbe Tisch getrunken hat. Legt die Regel einmal fest („aufteilen unter denen, die dabei waren"), nicht pro Beleg.

Nichts davon braucht ein Meeting. Es braucht eine Nachricht im Gruppenchat vor der Reise und die Disziplin, Kosten auf die vereinbarte Art zu erfassen. [Unser kompletter Guide zur Kostenteilung](/de/blog/how-to-split-travel-expenses/) geht tiefer auf faire Methoden bei ungleichen Situationen ein.
...
- **Eine gemeinsame Aufzeichnung.** Alle erfassen ihre eigenen Kosten in derselben Reise, es gibt also keinen Abgleichschritt — die Aufstellung *ist* der Abgleich.
- **Export pro Person.** Jede:r reicht die eigene Forderung aus dem eigenen Teil des Berichts ein, im gleichen Format wie alle anderen.
- **Keine Konto-Hürde.** Wenn das Tool von jedem Teilnehmenden ein Konto verlangt und eine IT-Freigabe braucht, wird es nicht genutzt und ihr seid zurück bei der Tabelle. Gast-Beitritt per Link umgeht das komplett.

Dafür haben wir eine eigene Anleitung geschrieben: [der Guide zum Firmen-Offsite planen](/de/use-cases/corporate-offsite-planner/).
