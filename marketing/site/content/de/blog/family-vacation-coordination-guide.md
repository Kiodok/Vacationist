---
title: Familienurlaub über mehrere Haushalte koordinieren (2026)
description: Großeltern, Geschwister-Familien, Kinder: wie man einen Familienurlaub über mehrere Haushalte plant — mit gemeinsamen Kalendern, fairer Kostenteilung zwischen Familien und sicher geteilten Reisedokumenten.
path: /de/blog/family-vacation-coordination-guide/
lang: de
type: article
schema: BlogPosting
date: 2026-07-21
...
- **Verfolge ab der ersten Buchung, sichtbar.** Anzahlungen, Fährtickets, der große Supermarkt-Einkauf — erfasst, während sie passieren, mit angehängtem Beleg, [Salden für jeden Haushalt sichtbar](/de/features/expenses/), einmal am Ende abgerechnet. Die Alternative — ein Geschwister streckt alles vor und schickt in Woche zwei eine aufgeschlüsselte E-Mail — erzeugt zuverlässig den einzigen echten Konflikt der Reise. Der [Kostenteilungs-Guide](/de/blog/how-to-split-travel-expenses/) behandelt die Mechanik.
...
Mach es richtig: Jeder Haushalt bewahrt seine Dokumente in [Vacationists verschlüsseltem Tresor](/de/features/travel-documents/) auf (verschlüsselt gespeichert, biometrische Sperre) und gewährt der buchenden Person der Reise **temporären Zugriff**. Dieser Zugriff beginnt erst zu laufen, wenn die Person die Dokumente tatsächlich öffnet, endet dann nach der von dir gesetzten Dauer von selbst und verfällt nach sieben Tagen, wenn er nie genutzt wird — niemand muss also daran denken, ihn nach ausgestellten Tickets abzuschalten. Die Buchung passiert trotzdem; die permanenten Chat-Kopien nicht. Für Familien ist das wohl die wertvollste Funktion der App — und eine, die keine andere Reise-App hat.
...
- **Gemeinsame Listen für die Haushaltsmaschine.** Der Supermarkt-Einkauf für zwölf, die Strandtaschen-Inventur, wessen Auto das Reisebett bringt — [Live-Listen](/de/features/shopping-lists/) mit Namen an den Einträgen. Funktioniert offline auf dem Campingplatz und im Supermarkt-Untergeschoss, synchronisiert danach.
