...
| | Vacationist | TripIt |
|---|---|---|
| Reiseplan aus Bestätigungs-E-Mails | ❌ Manuelle Eingabe | ✅ Hervorragend, automatisch |
...
- **Keine Kostenteilung, überhaupt keine.** TripIt kennt kein Konzept von „wer hat was bezahlt" oder „wer schuldet wem" — die größte funktionale Lücke bei einer Gruppenreise, wo Geld meist der stressigste Teil ist.
...
Nur eingeschränkt. TripIt dreht sich um den Plan einer Reisenden, den andere ansehen oder verfolgen können; es gibt keine Gruppenabstimmung, gemeinsame Kostenverfolgung oder Gästeteilnahme ohne Konto wie bei Vacationist.
