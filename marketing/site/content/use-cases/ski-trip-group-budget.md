...
appLd: true
date: 2026-08-05
altPath: /de/use-cases/ski-trip-group-budget/
keywords: ski trip planner group, split ski trip costs, chalet group booking, ski trip budget app
related: /features/expenses/, /features/voting/, /blog/how-to-plan-a-group-trip/
breadcrumbLabel: Ski trip group budget
---

# Plan a ski trip group budget without the chalet math headache

<div class="tldr">
  <p class="tldr-label">Short answer</p>
  <p>Vacationist splits the chalet, lift passes, and gear rental fairly even when everyone's paying for different things, and lets the group vote on rest days versus resort days before it turns into a group-chat debate.</p>
</div>
...
Every cost updates the group's balances immediately, so settling up happens naturally throughout the week instead of becoming an awkward post-trip conversation about who still owes for the gear rental.
...
### Can we split the chalet cost unevenly if rooms are different sizes?

Yes. Every expense supports custom splits, so the chalet cost can be divided by room size or however the group agrees, not just evenly across everyone.
