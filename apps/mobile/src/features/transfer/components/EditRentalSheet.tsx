  ...
  useEffect(() => {
    if (visible) {
      reset({
        ...
        pickup_date: rental.pickup_date ?? undefined,
        dropoff_date: rental.dropoff_date ?? undefined,
        ...
        <View className="flex-1 justify-end">
          ...
          <View className="bg-surface-elevated rounded-t-lg px-md pt-md pb-xl max-h-[90%]">
            ...
            <View className="flex-row items-center justify-between mb-md">
              <Text className="text-heading-m text-text-primary">Edit Rental Car</Text>
