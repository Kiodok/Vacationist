...
export function EmptyPacking() {
  ...
  return (
    <View className="flex-1 items-center justify-center gap-sm px-xl">
      <ThemedIcon name="bag-outline" size={48} color={colors.textMuted} />
...
export function EmptySharedPacking() {
  ...
  return (
    <View className="flex-1 items-center justify-center gap-sm px-xl">
      <ThemedIcon name="people-outline" size={48} color={colors.textMuted} />
...
export function EmptyLostFound() {
  ...
  return (
    <View className="flex-1 items-center justify-center gap-sm px-xl">
      <ThemedIcon name="search-outline" size={48} color={colors.textMuted} />
